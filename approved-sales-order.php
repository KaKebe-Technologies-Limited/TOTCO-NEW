                  ...
                  <div class="card-statistic-4">
                    <div class="align-items-center justify-content-between">
                      <div class="row ">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                          <div class="card-content">
                            <h5 class="font-10 text-white text-upper">Agent Name</h5>
                            <h1 class="font-15 text-white mb-0">Oluk Mark</h1>
                          </div>
                        </div>
          ...
          <div class="row d-flex">
            <div class="col-md-8">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="bg-dark-chessnut rounded p-4 d-flex justify-content-between mb-4">
                    <div>
